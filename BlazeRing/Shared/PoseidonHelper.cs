...
public static class PoseidonHelper
{
    ...
    public static (string secretKey, string ethAddress, string publicKeyX, string publicKeyY) GetL2PKFromMetaMask(string seed, string ethAddress)
    {
        var sign = EDDSASignMetamask(seed, ethAddress, true);
